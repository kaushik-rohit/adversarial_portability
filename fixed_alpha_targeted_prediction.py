...
def classification_on_target(rank, target, attack, alpha):
    ...
    for source in model_names:
        ...
        path_to_adv_ex = '/local/scratch/rohit/datasets/ImageNet/ILSVRC2012/adv_target_ex/{}/{}/{}/{}'.format(target_option, source, attack, alpha)
...
def caculate_adversary_with_fixed_alpha():
    for attack in attacks:
        for alpha in alphas:
            ...
            res_df.to_csv('targeted_{}_{}_alpha={}_preds.csv'.format(target_option, attack, alpha), index=False)
